...
description: |
  A quick introductory tutorial about Linear Regression Analysis and how to use R to perform it.
categories:
  - Linear Regression
  - R
  - OLS
...
- The increase of one square feet in size lot, implies the increase (on average) of 2.076e-03 thousand USD in house prices
- The increase of one square feet in size house, implies the increase (on average) of 1.242e-01 thousand USD in house prices


Finally, the summary( )'s output also provides useful information to test $$H_0: \beta_{bdrms}=0,\beta_{lotsize}=0,\beta_{sqrft}=0,\beta_{colonial}=0$$ versus $$H_1: H_0 \text{ is not true. }$$
...
### A little bit more about interpretation
